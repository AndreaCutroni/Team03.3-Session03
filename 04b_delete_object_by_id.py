"""
04 - Delete an Object by Id

This script demonstrates how to find and delete an object by its Id
...
TARGET_ID = "00ac48228290ed03e3528ba2beee1b8c"
...
def main():
    ...
    print(f"\n--- Delete object {TARGET_ID} ---")
    
    if find_and_delete_object(data, TARGET_ID):
        print(f"✓ Object deleted successfully")
    else:
        print(f"✗ Could not find object with id: {TARGET_ID}")
        return
    ...
    version = client.version.create(CreateVersionInput(
        ...
        modelId=MODEL_ID,
        objectId=object_id,
        message=f"Deleted object {TARGET_ID}"
    ))
